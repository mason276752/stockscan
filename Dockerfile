...
ENV PORT=3000 STOCKSCAN_STORE=/app/data/store STOCKSCAN_CACHE=/app/data/cache.sqlite STOCKSCAN_BARS=/app/data/bars STOCKSCAN_DB=/app/data/stockscan.sqlite
EXPOSE 3000
